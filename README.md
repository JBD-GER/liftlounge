...
Das Kontaktformular sendet über die serverseitige Route `/api/contact` eine Bestätigung an die Kundin und eine Anfrage-Mail an `info@liftlounge.de`. Eine Kopie der Anfrage geht zusätzlich an `lea.kirfel@web.de`.
...
CONTACT_CC_EMAIL="lea.kirfel@web.de"
```
